...
public class Ex03_String {
	...
	//String역시 Class 이기 때문에 멤버를 가지고 있다. 
	...
	public static void main(String[] args) {
		...
		//subString메소드를 코드 자동완성(컨트롤 스페이스)로 해보고 호출해보기
		System.out.println("subString(int):"+str1.substring(0));// 내가 준 index0부터 문자열끝까지 출력
		System.out.println("subString(int, int): "+ str1.substring(1,3)); //index 1부터 3의 앞까지 추출
		
		//charAt():문자열에서 특정 문자 한 글자만 추출?
		System.out.println("charAt():"+ str1.charAt(1)); //[a][p][p][l][e]
		System.out.println("↑subString():" +str1.substring(4,5));//subString을 이용해서 e만 출력고치게 해보기
