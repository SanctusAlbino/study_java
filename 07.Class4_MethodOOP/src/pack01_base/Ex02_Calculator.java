...
public class Ex02_Calculator {
	...
	//	메소드 내용(코드)
	//}
	//파라메터부: '어떤것이든' 메소드 실행 될떄 필요한 (변수, 클래스등)정보가 있다면 받아오게끔 처리하는 부분
	...
	//powerOff에서 main에 접근되는 이유?
	//static멤버여서 메모리에 먼저있기 때문
	...
	//return 타입이 void가 아니게 주어지면 해당하는 타입을 return 키워드가 반드시 필요하다.
	int test() {
		return 0;
	}
	
	int plus(int num1, int num2) {//1. 피라메터부에 숫자를 두개 입력받게 만들기
								  //2. 입력받은 피라메터 두 숫자의 합을 return하게 코딩해보기
								  //3. main에서 호출해보기
		//int sum = num1+num2;
	...
	Ex02_Calculator myEc(Ex02_Calcultor ec) {
		return new Ex02_Calculator();
	}
	
	
	//숫자 세개를 입력받아서 3개의 합을 구하는 메소드 plus3이라는 것을 만들어보기
	//메인 메소드를 가진 Main클래스에서 plus3메소드를 호출해서 합을 출력하고 평균도 출력해보기
